...
public class PacientsWindow {
    ...
    private TableColumn<String, String> column1 = new TableColumn<>("ФИО пациента");
    private TableColumn<String, String> column2 = new TableColumn<>("Лечение");
    private TableColumn<String, String> column3 = new TableColumn<>("Дополнительное обследование");
